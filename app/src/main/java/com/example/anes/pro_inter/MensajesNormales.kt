...
class MensajesNormales : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_mensajes_normales, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        rv_MensajesNormales.layoutManager = llm
        rv_MensajesNormales.adapter = adapter
        ...
        baseChat.child("NotasNormales").addChildEventListener(childEvent)

        fab.setOnClickListener { view ->
            val i = Intent(context,CrearMensajeNormal::class.java)
            startActivity(i)
        }
